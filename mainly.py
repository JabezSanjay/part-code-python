...
class HOTEL_MANAGEMENT:
    def __init__(self):
        ...
        def enter(event):
         self.Button2.config(bg = "#7B8483" , fg = "#10273F")
         self.Button3.config(bg = "#7B8483" , fg = "#18395c")
         self.Button4.config(bg = "#7B8483" , fg = "#214C7A")
         self.Button5.config(bg = "#7B8483" , fg = "#2D65A2")
         self.Button6.config(bg = "#7B8483" , fg = "#3F8ADB")

        def leave(event):
         self.Button2.config(bg = "#10273F" , fg = "#7B8483")   
         self.Button3.config(bg = "#18395c" , fg = "#7B8483")
         self.Button4.config(bg = "#214C7A" , fg = "#7B8483")
         self.Button5.config(bg = "#2D65A2" , fg = "#7B8483")
         self.Button6.config(bg = "#3F8ADB" , fg = "#7B8483")
        ...
        self.Button2.place(relx=0.35, rely=0.17, height=103, width=566)
        ...
        self.Button3.place(relx=0.35, rely=0.33, height=93, width=566)
        ...
        self.Button4.place(relx=0.35, rely=0.47, height=93, width=566)
        ...
        self.Button6.place(relx=0.35, rely=0.77, height=103, width=566)
