    ...
    def __init__(self):
        ...
        def submit_clicked():
            ...
            if part_1 == partGroup[0]:
                ...
                self.Message3.place(relx=0.30, rely=0.65, relheight=0.20, relwidth=0.40)
                self.Message3.configure(background="#3F8ADB")
                self.Message3.configure(font=font17)
                ...
                self.Message3.configure(highlightbackground="#ffffff")
                self.Message3.configure(highlightcolor="black")
                self.Message3.configure(text="{}{}{}{}{}{}{}".format(partGroup_dict[part_1],StainlessSteel1[part_2],'0','0',part_5,part_6,part_7))
                self.Message3.configure(width=1000)
                ...
                self.Message3.configure(highlightbackground="#ffffff")
                self.Message3.configure(highlightcolor="black")
                self.Message3.configure(text="{}{}{}{}{}{}{}".format(partGroup_dict[part_1],GalvanizedIron1[part_2],GalvanizedIron2[part_3],'0',part_5,part_6,part_7))
                self.Message3.configure(width=1000)
                ...
                self.Message3.configure(highlightbackground="#ffffff")
                self.Message3.configure(highlightcolor="black")
                self.Message3.configure(text="{}{}{}{}{}{}{}".format(partGroup_dict[part_1],Plywood1[part_2],Plywood2[part_3],'0',part_5,part_6,part_7))
                self.Message3.configure(width=1000)
                ...
                self.Message3.configure(highlightbackground="#ffffff")
                self.Message3.configure(highlightcolor="black")
                self.Message3.configure(text="{}{}{}{}{}{}{}".format(partGroup_dict[part_1],Timber1[part_2],Timber2[part_3],'0',part_5,part_6,part_7))
                self.Message3.configure(width=1000) 
                ...
                self.Message3.configure(highlightbackground="#ffffff")
                self.Message3.configure(highlightcolor="black")
                self.Message3.configure(text="{}{}{}{}{}{}{}".format(partGroup_dict[part_1],Cushions1[part_2],Cushions2[part_3],'0',part_5,part_6,part_7))
                self.Message3.configure(width=1000)
                ...
                self.Message3.configure(highlightbackground="#ffffff")
                self.Message3.configure(highlightcolor="black")
                self.Message3.configure(text="{}{}{}{}{}{}{}".format(partGroup_dict[part_1],AutoElectricals1[part_2],AutoElectricals2[part_3],'0',part_5,part_6,part_7))
                self.Message3.configure(width=1000)          
                ...
                self.Message3.configure(highlightbackground="#ffffff")
                self.Message3.configure(highlightcolor="black")
                self.Message3.configure(text="{}{}{}{}{}{}{}".format(partGroup_dict[part_1],RubberGoods1[part_2],RubberGoods2[part_3],'0',part_5,part_6,part_7))
                self.Message3.configure(width=1000)
                ...
                self.Message3.configure(highlightbackground="#ffffff")
                self.Message3.configure(highlightcolor="black")
                self.Message3.configure(text="{}{}{}{}{}{}{}".format(partGroup_dict[part_1],LaminatedSheets1[part_2],LaminatedSheets2[part_3],'0',part_5,part_6,part_7))
                self.Message3.configure(width=1000)
                ...
                self.Message3.configure(highlightbackground="#ffffff")
                self.Message3.configure(highlightcolor="black")
                self.Message3.configure(text="{}{}{}{}{}{}{}".format(partGroup_dict[part_1],DoorMaterials1[part_2],'0','0',part_5,part_6,part_7))
                self.Message3.configure(width=1000) 
                ...
                self.Message3.configure(highlightbackground="#ffffff")
                self.Message3.configure(highlightcolor="black")
                self.Message3.configure(text="{}{}{}{}{}{}{}".format(partGroup_dict[part_1],PVCItems1[part_2],PVCItems2[part_3],'0',part_5,part_6,part_7))
                self.Message3.configure(width=1000) 
                ...
                self.Message3.configure(highlightbackground="#ffffff")
                self.Message3.configure(highlightcolor="black")
                self.Message3.configure(text="{}{}{}{}{}{}{}".format(partGroup_dict[part_1],FRPMouldedItems1[part_2],'0','0',part_5,part_6,part_7))
                self.Message3.configure(width=1000) 
                ...
                self.Message3.configure(highlightbackground="#ffffff")
                self.Message3.configure(highlightcolor="black")
                self.Message3.configure(text="{}{}{}{}{}{}{}".format(partGroup_dict[part_1],ChemicalsAcids1[part_2],'0','0',part_5,part_6,part_7))
                self.Message3.configure(width=1000)                
                ...
                self.Message3.configure(highlightbackground="#ffffff")
                self.Message3.configure(highlightcolor="black")
                self.Message3.configure(text="{}{}{}{}{}{}{}".format(partGroup_dict[part_1],Insulation1[part_2],'0','0',part_5,part_6,part_7))
                self.Message3.configure(width=1000)
                ...
                self.Message3.configure(highlightbackground="#ffffff")
                self.Message3.configure(highlightcolor="black")
                self.Message3.configure(text="{}{}{}{}{}{}{}".format(partGroup_dict[part_1],LubricantsAdhesives1[part_2],'0','0',part_5,part_6,part_7))
                self.Message3.configure(width=1000)    
        ...
        font16 = "-family {Segoe UI} -size 15 -weight bold -slant "  \
            "roman -underline 0 -overstrike 0"
        font17 = "-family {Times New Roman} -size 38 -weight bold -slant "  \
            "roman -underline 0 -overstrike 0"
        ...
        self.Frame3.configure(relief=GROOVE)
        self.Frame3.configure(background="#3F8ADB")
        ...
        self.Frame1.configure(relief=GROOVE)
        self.Frame1.configure(background="#214C7A")
        ...
        self.Message3.place(relx=0.22, rely=0.11, relheight=0.79, relwidth=0.60)
        self.Message3.configure(background="#214C7A")
        self.Message3.configure(font=font11)
        self.Message3.configure(foreground="skyblue1")
        self.Message3.configure(highlightbackground="#ffffff")
        self.Message3.configure(highlightcolor="black")
        self.Message3.configure(text=''' PART CODE GENERATOR''')
        self.Message3.configure(width=1000)
        ...
        self.Label3.configure(foreground="skyblue1")
        ...
        self.Label5.configure(foreground="skyblue1")
        ...
        self.Label4.configure(background="#2D65A2")
        self.Label4.configure(disabledforeground="#bfbfbf")
        self.Label4.configure(font=font12)
        self.Label4.configure(foreground="skyblue1")
        ...
        self.Label1.configure(background="#2D65A2")
        self.Label1.configure(disabledforeground="#bfbfbf")
        self.Label1.configure(font=font12)
        self.Label1.configure(foreground="skyblue1")
        ...
        self.Message5.configure(background="#2D65A2")
        self.Message5.configure(font=font13)
        self.Message5.configure(foreground="skyblue1")
        ...
        self.Message4.configure(background="#2D65A2")
        self.Message4.configure(font=font13)
        self.Message4.configure(foreground="skyblue1")
        ...
        self.Message6.configure(background="#2D65A2")
        self.Message6.configure(font=font13)
        self.Message6.configure(foreground="skyblue1")
        ...
        self.Message8.configure(background="#2D65A2")
        self.Message8.configure(font=font13)
        self.Message8.configure(foreground="skyblue1")
